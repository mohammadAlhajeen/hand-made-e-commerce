...
import com.hand.service.CompanyService;
...
public class authController {
    ...
    public ResponseEntity<?> companyRegister(@ModelAttribute AppUserRegisterDTO registerDTO,@RequestPart(value = "image",required = false)MultipartFile image) {
    ...
    public ResponseEntity<?> Login(@RequestBody LogInRequest login) {
        ...
        try {
           return new ResponseEntity<>(
                   authLog.LogInAppUser(login), HttpStatus.OK);
        } catch (Exception e) {
